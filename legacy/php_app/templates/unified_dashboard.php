...
$stmt = $pdo->query("SELECT * FROM dashboard_services");
    ...
    <header class="sticky top-0 z-50 bg-background-dark/95 backdrop-blur-md border-b border-slate-700 shadow-xl">
        <div class="container mx-auto px-4 py-4 flex justify-between items-center">
            ...
            <div style="display: flex; align-items: center; gap: 15px;">
                <span class="text-slate-300">Welcome, <?php echo htmlspecialchars($_SESSION['user'] ?? 'User'); ?> (<?php echo htmlspecialchars($_SESSION['user_type'] ?? 'Customer'); ?>)</span>
                <a href="logout.php" class="text-white text-sm text-decoration-none px-2 py-1 bg-red-500 rounded">Logout</a>
            </div>
        </div>
        ...
        <section class="pt-8" id="features">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
                ...
                <div class="feature-card p-6 rounded-xl shadow-lg" data-aos="fade-up">
                    <a href="Docs.php" class="flex flex-col items-center text-center space-y-3">
                ...
                <div class="feature-card p-6 rounded-xl shadow-lg" data-aos="fade-up" data-aos-delay="50">
                    <a href="Fleetoptimization.php" class="flex flex-col items-center text-center space-y-3">
                ...
                <div class="feature-card p-6 rounded-xl shadow-lg" data-aos="fade-up" data-aos-delay="100">
                    <a href="Financialinsight.php" class="flex flex-col items-center text-center space-y-3">
                ...
                <div class="feature-card p-6 rounded-xl shadow-lg" data-aos="fade-up" data-aos-delay="150">
                    <a href="insurancefinance.php" class="flex flex-col items-center text-center space-y-3">
                ...
                <div class="feature-card p-6 rounded-xl shadow-lg" data-aos="fade-up" data-aos-delay="200">
                    <a href="vechiclemaintenance.php" class="flex flex-col items-center text-center space-y-3">
                ...
                <div class="feature-card p-6 rounded-xl shadow-lg" data-aos="fade-up" data-aos-delay="250">
                    <a href="Fuelandexpensestracking.php" class="flex flex-col items-center text-center space-y-3">
                ...
                <div class="feature-card p-6 rounded-xl shadow-lg" data-aos="fade-up" data-aos-delay="300">
                    <a href="GPSandtelematics.php" class="flex flex-col items-center text-center space-y-3">
                ...
                <div class="feature-card p-6 rounded-xl shadow-lg" data-aos="fade-up" data-aos-delay="350">
                    <a href="Driversafety.php" class="flex flex-col items-center text-center space-y-3">
                ...
                <div class="feature-card p-6 rounded-xl shadow-lg" data-aos="fade-up" data-aos-delay="400">
                    <a href="EVtools.php" class="flex flex-col items-center text-center space-y-3">
                ...
                <div class="feature-card p-6 rounded-xl shadow-lg" data-aos="fade-up" data-aos-delay="450">
                    <a href="Compliance%20and%20regulations.php" class="flex flex-col items-center text-center space-y-3">
                ...
                <div class="feature-card p-6 rounded-xl shadow-lg" data-aos="fade-up">
                    <a href="Vechicleresearch.php" class="flex flex-col items-center text-center space-y-3">
                ...
                <div class="feature-card p-6 rounded-xl shadow-lg" data-aos="fade-up" data-aos-delay="50">
                    <a href="fleetmanagement.php" class="flex flex-col items-center text-center space-y-3">
                ...
                <div class="feature-card p-6 rounded-xl shadow-lg" data-aos="fade-up" data-aos-delay="100">
                    <a href="Logistics%20and%20delivery.php" class="flex flex-col items-center text-center space-y-3">
                ...
                <div class="feature-card p-6 rounded-xl shadow-lg" data-aos="fade-up" data-aos-delay="150">
                    <a href="Agricultural.php" class="flex flex-col items-center text-center space-y-3">
                ...
                <div class="feature-card p-6 rounded-xl shadow-lg" data-aos="fade-up" data-aos-delay="200">
                    <a href="Ecom.php" class="flex flex-col items-center text-center space-y-3">
                ...
                <div class="feature-card p-6 rounded-xl shadow-lg" data-aos="fade-up" data-aos-delay="250">
                    <a href="financial_services.php" class="flex flex-col items-center text-center space-y-3">
                ...
                <div class="feature-card p-6 rounded-xl shadow-lg" data-aos="fade-up" data-aos-delay="300">
                    <a href="valuation.php" class="flex flex-col items-center text-center space-y-3">
                ...
                <div class="feature-card p-6 rounded-xl shadow-lg" data-aos="fade-up" data-aos-delay="350">
                    <a href="legalServices.php" class="flex flex-col items-center text-center space-y-3">
                ...
                <div class="feature-card p-6 rounded-xl shadow-lg" data-aos="fade-up" data-aos-delay="400">
                    <a href="trafficmanagement.php" class="flex flex-col items-center text-center space-y-3">
                ...
                <div class="feature-card p-6 rounded-xl shadow-lg" data-aos="fade-up" data-aos-delay="450">
                    <a href="delaerhsip%20search.php" class="flex flex-col items-center text-center space-y-3">
                ...
                <div class="feature-card p-6 rounded-xl shadow-lg" data-aos="fade-up">
                    <a href="bankauction.php" class="flex flex-col items-center text-center space-y-3">
                ...
                <div class="feature-card p-6 rounded-xl shadow-lg" data-aos="fade-up" data-aos-delay="50">
                    <a href="customersupport.php" class="flex flex-col items-center text-center space-y-3">
                ...
                <div class="feature-card p-6 rounded-xl shadow-lg" data-aos="fade-up" data-aos-delay="100">
                    <a href="markettrends.php" class="flex flex-col items-center text-center space-y-3">
                ...
                <div class="feature-card p-6 rounded-xl shadow-lg" data-aos="fade-up" data-aos-delay="150">
                    <a href="Custom.php" class="flex flex-col items-center text-center space-y-3">
                ...
                <div class="feature-card p-6 rounded-xl shadow-lg" data-aos="fade-up" data-aos-delay="200">
                    <a href="VechicleResale.php" class="flex flex-col items-center text-center space-y-3">
                ...
                <div class="feature-card p-6 rounded-xl shadow-lg" data-aos="fade-up" data-aos-delay="250">
                    <a href="parts&accessroy.php" class="flex flex-col items-center text-center space-y-3">
                ...
                <div class="feature-card p-6 rounded-xl shadow-lg" data-aos="fade-up" data-aos-delay="300">
                    <a href="rideshareing.php" class="flex flex-col items-center text-center space-y-3">
                ...
                <div class="feature-card p-6 rounded-xl shadow-lg" data-aos="fade-up" data-aos-delay="350">
                    <a href="app.php" class="flex flex-col items-center text-center space-y-3">
                ...
                <div class="feature-card p-6 rounded-xl shadow-lg" data-aos="fade-up" data-aos-delay="400">
                    <a href="telematics.php" class="flex flex-col items-center text-center space-y-3">
                        ...
                        <p class="text-sm text-slate-400">Utilize analytics for detailed
